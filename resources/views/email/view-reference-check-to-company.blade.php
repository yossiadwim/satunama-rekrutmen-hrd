<p>Yth. {{ $data_email_reference_check['nama_perusahaan'] }}</p>
...
<p>
    ...
    2. Is it true that the applicant has been in the position of {{ $data_email_reference_check['posisi'] }} in your company?
