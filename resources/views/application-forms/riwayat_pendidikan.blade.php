...
@if ($pendidikanExists)
                ...
                <tr id="table-row-riwayat-pendidikan">
                    ...
                    <td>
                        <input type="text" class="form-control" id="nama_institusi" name="nama_institusi[]"
                            ...
                            value="{{ old('jenjang_pendidikan', $pendidikan->nama_institusi) == null ? '' : $pendidikan->nama_institusi }}" disabled>
                    </td>
                    <td>
                        <input type="text" class="form-control" id="jurusan" name="jurusan[]"
                            placeholder="Jurusan"
                            value="{{ old('jenjang_pendidikan', $pendidikan->jurusan) == null ? '' : $pendidikan->jurusan }}" disabled>
                    </td>
                    <td>
                        <input type="text" class="form-control" id="tahun_selesai" name="tahun_selesai[]"
                            placeholder="Tahun Selesai"
                            value="{{ old('jenjang_pendidikan', $pendidikan->tahun_selesai) == null ? '' : $pendidikan->tahun_selesai }}" disabled>
                    </td>
                    <td>
                        <input type="text" class="form-control" id="ipk" name="ipk[]"
                            placeholder="Indeks Prestasi Kumulatif (IPK)"
                            value="{{ old('jenjang_pendidikan', $pendidikan->ipk) == null ? '' : $pendidikan->ipk }}" disabled>
                    </td>
                </tr>
            @endforeach

        </tbody>
        <tbody id="table-body-riwayat-pendidikan-2">
            <tr id="table-row-riwayat-pendidikan-2">
    ...
    <div class="col-2">
        <div class="form-floating">
            <input type="number" class="form-control" name="jumlah_riwayat_pendidikan"
                id="jumlah_riwayat_pendidikan" placeholder="Jumlah Riwayat Pendidikan"
                onchange="addRowTableEducation()" min="0">
            <label for="jumlah_riwayat_pendidikan">Tambah</label>
        </div>
...
<div class="mb-3 mt-5 col-3">
    <label for="formFile" class="form-label">Unggah Sertifikat</label>
