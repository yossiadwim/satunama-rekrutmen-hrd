<nav class="navbar navbar-expand-lg border shadow-sm">
    <div class="container ">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            @can('user')
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item mb-2" href="/profil-kandidat/users/{{ $user->slug }}"
                                    ...
                                    <li><a class="dropdown-item mb-2"
                                            ...
                                            Lamaran Saya</a></li>
                                    <li><a class="dropdown-item mb-2"
                                            href="/profil-kandidat/users/{{ $user->slug }}/pengaturan-akun"><i
