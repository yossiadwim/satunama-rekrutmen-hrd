...
<body style="font-family: Poppins">
    ...
    <div class="container d-flex border-bottom border-secondary">
        ...
        <div class="mt-5 mb-4 px-5">
            <a href="/admin-dashboard/jobs/create" class="btn btn-primary bg-btn border-0" role="button"
        ...
        <div class="row mt-4">
            <div class="col-2 border-end border-secondary">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button class="nav-link active mb-3" id="v-pills-aktif-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-aktif" type="button" role="tab" aria-controls="v-pills-home"
                        aria-selected="true">Aktif</button>
                    <button class="nav-link" id="v-pills-tutup-tab" data-bs-toggle="pill"
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="btn-group col-md-3" role="group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item"
                                                                        href="/admin-dashboard/jobs/{{ $job->slug }}/edit">Edit
                                                                        Lowongan</a>
                                                                </li>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah sudah yakin ingin menutup lowongan?</p>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form method="POST"
                                                                            action="/admin-dashboard/jobs/{{ $job->slug }}/closeJobs">
                                                                            @csrf
                                                        ...
                                                        <div class="col-md-3">
                                                            <a class="btn btn-secondary"
                                                                href="/admin-kelola-kandidat/{{ $job->slug }}"
                                                                role="button">Kelola
                                                                Kandidat</a>
                                                        </div>
                                                    </div>
