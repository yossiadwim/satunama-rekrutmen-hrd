...
<body style="font-family: Poppins">
    ...
    @auth
        <div class="offcanvas offcanvas-end " data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
            id="notifikasi_admin" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="offcanvas-body">
                {{-- @foreach ($notifikasi as $notif)
                    <a href="#" class="list-group-item list-group-item-action active" aria-current="true">
                        ...
                        <p class="mb-1">Status lamaran diperbarui ke Tahap
            ...
            <div class="col-1 border-end border-secondary">
                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button class="nav-link btn-bg " id="v-pills-tutup-tab" data-bs-toggle="pill"
                        data-bs-target="#v-pills-tutup" type="button" role="tab"
                        aria-controls="v-pills-profile" aria-selected="false">Tutup</button>
                </div>
            </div>
                                            ...
                                            <div class="card shadow-sm mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="modal fade" id="lowongan-{{ $job->slug }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form method="POST"
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button class="btn btn-success btn-tutup-lowongan"
                                                                                type="submit" value="{{ $job->slug }}"
