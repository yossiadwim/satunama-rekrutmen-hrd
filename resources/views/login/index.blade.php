          ...
          <main class="form-signin w-100 m-auto">
            ...
            <form action="/login" method="post">
              ...
              <div class="form-floating">
                <input type="email" name="email" class="form-control rounded @error('email')
                  is-invalid
              ...
              <div class="form-floating">
                <input type="password" name="password" class="form-control rounded mt-4" id="password" placeholder="Password" required>
