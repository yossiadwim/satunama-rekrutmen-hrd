      ...
      <div class="col-md-4">
        <div class="card card-container mt-5">
          <main class="form-registration w-100 m-auto">
              ...
              @csrf
                <div class="form-floating">
                    <input type="text" name="name" class="form-control rounded @error('name')
                      is-invalid
                    @enderror" id="name" placeholder="name@example.com" required value="{{old('name')}}">
                ...
                <div class="form-floating">
                    <input type="email" name="email" class="form-control rounded mt-3 @error('email')
                      is-invalid
                ...
                <div class="form-floating">
                    <input type="password" name="password" class="form-control rounded mt-3 @error('password')
                      is-invalid
            ...
            <div class="d-flex align-items-center justify-content-center">
              <a href="{{route('google-auth')}}"><img src="{{ asset('img/google.png') }}" class= "mt-4" alt="Gambar" width="40" height="40"></a>
            </div>
          </main>
        </div>
      </div>
