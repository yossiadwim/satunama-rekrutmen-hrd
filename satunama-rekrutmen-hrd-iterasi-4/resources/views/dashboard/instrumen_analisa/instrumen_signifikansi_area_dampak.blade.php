                                ...
                                <div class="accordion-body">
                                    <form
                                        ...
                                        <label for=""><span class="badge text-bg-secondary"
                                                id="label_bobot_signifikansi_area_dampak-{{ $data->id_jenis_analisa }}">0</span></label>

                                        <input type="range" class="form-range form-range-signifikansi-area-dampak mb-5" min="{{ $data->bobot_minimal }}"
                                            max="{{ $data->bobot_maksimal }}" step="1" value="{{ $data->id_jenis_analisa }}"
                                            id="range-signifikansi-area-dampak-{{ $data->id_jenis_analisa }}" oninput="getID({{ $data->id_jenis_analisa }})"
                                            name="bobot">
