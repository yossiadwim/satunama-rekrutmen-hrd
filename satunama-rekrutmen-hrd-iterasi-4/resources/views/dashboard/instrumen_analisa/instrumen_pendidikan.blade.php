                            ...
                            <div id="pendidikan_{{ $data->id_jenis_analisa }}" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <form
                                        ...
                                        <label for=""><span class="badge text-bg-secondary" id="label_bobot_pendidikan-{{ $data->id_jenis_analisa }}">0</span></label>

                                        <input type="range" class="form-range form-range-pendidikan mb-5" min="{{ $data->bobot_minimal }}"
                                            max="{{ $data->bobot_maksimal }}" step="1" value="{{ $data->id_jenis_analisa }}"
                                            id="range-pendidikan-{{ $data->id_jenis_analisa }}" name="bobot" oninput="getID({{ $data->id_jenis_analisa }})">
